...
export class ContactPage {
  ...
  {
    console.log('map');
    let destination = 28.676038 + ',' + 77.439995;
    
    this.get_user_lang();    
    
    let label = encodeURI('Chirag Shah D-103, Emerald Apartment, Parsi Panchayat Cross Road Opp.Sona Udyog, Andheri East Mumbai :400069)');
